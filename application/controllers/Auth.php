...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			if ($this->form_validation->run() === TRUE) {
				...
				$this->data['title'] = "Login Aplikasi";
				$this->data['halaman'] = "login";
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data, $group_user)) {
			...
			$this->data['title'] =  'Daftar Akun AJAR.IN';
			$this->data['halaman'] = "daftar";
			$this->_render_page('master' . DIRECTORY_SEPARATOR . 'header', $this->data);
