    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-md-8 col-lg-5">
                <!-- Contact Box -->
                <div class="contact-box bg-white text-center rounded p-4 p-sm-5 mt-5 mt-lg-0 pb-5 shadow-lg">
                    <!-- Contact Form -->
                    ...
                    <div class="col-12">
                        <a href="<?= base_url() ?>auth/create_user"><button
                                class="btn btn-masuk btn-bordered w-100 mt-3 mt-5" type="button">Mendaftar</button></a>
                    </div>
                    <div class="col-12">
                        <a href="<?= base_url() ?>auth/login"><button class="btn btn-bordered w-100 mt-3 mt-sm-4"
