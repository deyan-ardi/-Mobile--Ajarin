        ...
        <div class="row align-items-center justify-content-center mt-4">
            <div class="col-12 col-md-8 col-lg-12">
                ...
                <div class="contact-box bg-white text-left rounded p-3 mt-lg-5 mt-3 shadow-lg">
                    <!-- Contact Form -->
                    <h5 class="text-primary">Kelas Saya</h5>
                </div>
            </div>
        </div>
        <div class="row" id="result">
            ...
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="contact-box bg-white text-left rounded p-3 mt-4 shadow-lg">
                    <!-- Contact Form -->
                    <?php if (!$this->ion_auth->in_group(2) && $_SESSION['user_id'] == $data['id_user'] && $data['status'] == "Pemilik") : ?>
                    ...
                    <?php if (!$this->ion_auth->in_group(2) && $_SESSION['user_id'] == $data['id_user'] && $data['status'] == "Pemilik") : ?>
                    <p class="mt-4 pt-2">[PENGAJAR] - <span class="text-primary">Anda Adalah Pengajar Dikelas Ini</span>
                        </php>
                        <?php else : ?>
                    <p class="mt-4 pt-2">[PENGAJAR] - <?= ucwords($data['created_by']) ?></php>
                        <?php endif; ?>
