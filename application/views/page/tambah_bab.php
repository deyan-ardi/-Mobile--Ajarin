        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-12">
                ...
                <div class="contact-box bg-white text-left rounded p-3 mt-4 shadow-lg">
                    <a href="<?= base_url() ?>home/tambah_bab/<?= $kelas[0]['id_kelas'] ?>">
                        <h5 class="text-primary">Tambah Bab Pembelajaran</h5>
                    </a>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_bab" id="nama_bab" required class="form-control"
                                        placeholder="Nama Bab Pembelajaran">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" required class="form-control" cols="30"
                                        placeholder="Deskripsi Bab Pembelajaran" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
